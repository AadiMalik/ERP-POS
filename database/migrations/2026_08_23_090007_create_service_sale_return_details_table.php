...
return new class extends Migration
{
    public function up()
    {
        Schema::create('service_sale_return_details', function (Blueprint $table) {
            $table->uuid('service_sale_return_detail_id')->primary();
            $table->uuid('service_sale_return_id')->nullable();
            $table->uuid('service_sale_id')->nullable();
            $table->uuid('service_sale_detail_id')->nullable();
    ...
    {
        Schema::dropIfExists('service_sale_return_details');
    }
};
