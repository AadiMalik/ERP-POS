...
return new class extends Migration
{
    public function up()
    {
        Schema::create('service_purchase_details', function (Blueprint $table) {
            $table->uuid('service_purchase_detail_id')->primary();
    ...
    {
        Schema::dropIfExists('service_purchase_details');
    }
};
