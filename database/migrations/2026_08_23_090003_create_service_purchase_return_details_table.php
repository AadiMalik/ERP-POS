...
return new class extends Migration
{
    public function up()
    {
        Schema::create('service_purchase_return_details', function (Blueprint $table) {
            $table->uuid('service_purchase_return_detail_id')->primary();
            $table->uuid('service_purchase_return_id')->nullable();
            $table->uuid('service_purchase_id')->nullable();
            $table->uuid('service_purchase_detail_id')->nullable();
    ...
    {
        Schema::dropIfExists('service_purchase_return_details');
    }
};
