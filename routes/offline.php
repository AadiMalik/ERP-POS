...
Route::middleware(['auth:sanctum', 'module:pos', 'throttle:60,1'])->group(function () {
...
Route::middleware(['auth:sanctum', 'offline.pos.device', 'module:pos', 'throttle:120,1'])->group(function () {
