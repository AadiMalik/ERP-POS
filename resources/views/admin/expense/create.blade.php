...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">{{ isset($expense) ? 'Update' : 'New' }} Expense</h4>
        <div class="card">
            <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                <h5 class="mb-0">{{ isset($expense) ? 'Update' : 'Create' }} Expense</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-control select2" name="pos_register_session_id" id="pos_register_session_id">
                                    <option value="">--No Session (Admin Expense)--</option>
