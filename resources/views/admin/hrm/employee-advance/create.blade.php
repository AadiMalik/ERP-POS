...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">{{ __('hrm_advances.new_heading') }}</h4>
        ...
        <form action="{{ url('admin/employee-advance') }}" method="POST">
            ...
            <div class="card-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-3">
                        <label class="fw-semibold">{{ __('hrm_advances.installments') }} <span class="text-danger">*</span></label>
            ...
            <div class="card-footer border-top">
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button class="btn btn-primary px-4">{{ __('hrm_advances.submit_request') }}</button>
                </div>
            </div>
        </form>
    </div>
