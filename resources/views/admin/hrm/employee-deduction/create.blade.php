...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">Employee Deduction</h4>

    <div class="card">
        <div class="card-header bg-white border-bottom">
            <h5 class="mb-0">{{ isset($employee_deduction) ? 'Update' : 'New' }} Deduction</h5>
        </div>
        ...
        <form action="{{ url('admin/employee-deduction') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <label class="fw-semibold">Effective To</label>
                    ...
                    <div class="col-md-6 d-flex align-items-end">
                        <div class="form-check">
                            ...
                            <label class="form-check-label fw-semibold" for="is_recurring">Recurring every payroll run (within date range)</label>
                        </div>
                    </div>
                    @if (isset($employee_deduction))
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-select">
                            <option value="active" {{ ($employee_deduction->status ?? 'active') == 'active' ? 'selected' : '' }}>Active</option>
                            <option value="inactive" {{ ($employee_deduction->status ?? '') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                        </select>
                    </div>
                    @endif
                </div>
