                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control"
                            rows="3"
                            name="description">{{ old('description',$purchase->description ?? '') }}</textarea>
                        ...
                        <table class="table table-bordered table-striped"
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="min-width:120px;" class="request-column">
                                        Requested Qty
                                    </th>
...
<script>
    ...
    <tr class="product-row">
        ...
        <td class="request-column">
            ...
            <input
                type="text"
                class="form-control requested-qty"
                readonly
        ...
        <td class="request-column">
            ...
            <input
                type="hidden"
                name="products[${index}][quoted_quantity]"
                value="${data.quoted_quantity ?? ''}">
        ...
        <td>
            ...
            <input
                ...
                value="${data.ordered_quantity ?? data.quoted_quantity ?? ''}">
        ...
        <td>
            ...
            <input
                ...
                value="${data.received_quantity ?? data.ordered_quantity ?? data.quoted_quantity ?? ''}">
...
`);
    ...
    function addPurchaseRequestRow(item) {
        ...
        addProductRow({
            ...
            ordered_quantity: item.quoted_quantity,

            received_quantity: item.quoted_quantity,
...
`;
        ...
        row.find('.ordered-qty')
            .attr('max', item.quoted_quantity);

        row.find('.ordered-qty')
            .attr('data-max', item.quoted_quantity);
    ...
    function calculateRow(row) {
        ...
        if (purchaseType == 'purchase_request') {
            ...
            if (orderedQty > maxQty) {
                ...
                row.find('.ordered-qty').val(maxQty);
    ...
    function applyFooterCalculations() {
        ...
        let subtotal =
            decimal($('#subtotal').val());

        let rowDiscount =
            decimal($('#discount_amount').val());

        let rowTax =
            decimal($('#tax_amount').val());

        let invoiceDiscount =
            decimal($('#discount').val());

        let invoiceTax =
            decimal($('#tax').val());

        let shipping =
            decimal($('#shipping_charge').val());
        ...
        let invoiceTaxAmount =
            afterDiscount * invoiceTax / 100;
