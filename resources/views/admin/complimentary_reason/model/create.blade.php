...
<div class="modal fade" id="ajaxModel" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="complimentary_reason_form" name="complimentary_reason_form">
                <div class="modal-body">
                    <input type="hidden" name="complimentary_reason_id" id="complimentary_reason_id">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="{{ __('complimentary.reason_name_placeholder') }}" required>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label">
                                {{ __('common.status') }}
