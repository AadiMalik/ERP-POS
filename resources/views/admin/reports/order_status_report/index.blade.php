...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">{{ __('reports.order_status_report') }}</h4>
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex gap-2">
                    @canAccess('reports.order-status-report.print')
                    <a href="javascript:void(0);" id="btn_print" class="btn btn-outline-secondary">
                        <i class="fa fa-print"></i> {{ __('common.print') }}
                    </a>
                    @endcanAccess
                    @canAccess('reports.order-status-report.pdf')
                    <a href="javascript:void(0);" id="btn_pdf" class="btn btn-outline-danger">
                        <i class="fa fa-file-pdf"></i> {{ __('common.pdf') }}
                    </a>
                    @endcanAccess
                    @canAccess('reports.order-status-report.export')
                    <a href="javascript:void(0);" id="btn_excel" class="btn btn-outline-success">
                        <i class="fa fa-file-excel"></i> {{ __('common.excel') }}
                    </a>
                    @endcanAccess
                    @canAccess('reports.order-status-report.export-csv')
            ...
            <div class="card-body">
                ...
                <div class="row g-3 p-4 pb-0">
                    ...
                    <div class="col-md-3">
                        <div class="alert alert-secondary mb-0">
                            <strong>Gross Sales:</strong> <span id="grand_gross_display">-</span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="alert alert-secondary mb-0">
                ...
                <div class="table-responsive p-4">
                    <table id="order_status_report_table" class="table datatables">
                        <thead>
                            <tr>
                                ...
                                <th class="text-end">{{ __('reports.col_due') }}</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
@section('js')
    @include('admin.partials.datatable', [
        'columns' => "
                        ...
                        {data:'paid',name:'paid',sortable:false,className:'text-end'},
                        {data:'due',name:'due',sortable:false,className:'text-end'}",
        'route' => 'order-status-report/data',
        'buttons' => false,
        'pageLength' => 50,
        'notordering' => true,
        'class' => 'order_status_report_table',
        'variable' => 'order_status_report_table',
        'datefilter' => true,
    ...
    <script>
        ...
        $('#search_btn').click(function() {
            initDataTableorder_status_report_table();
            refreshTotals();
        });

        function refreshTotals() {
            $.ajax({
                url: url_local + '/admin/reports/order-status-report/data',
                type: 'POST',
                data: $.extend({
        ...
        $('#btn_print').click(function() {
            window.open(buildReportUrl('/admin/reports/order-status-report/print'), '_blank');
        });
        $('#btn_pdf').click(function() {
            window.open(buildReportUrl('/admin/reports/order-status-report/pdf'), '_blank');
        });
        $('#btn_excel').click(function() {
            window.location.href = buildReportUrl('/admin/reports/order-status-report/export');
        });
        $('#btn_csv').click(function() {
            window.location.href = buildReportUrl('/admin/reports/order-status-report/export-csv');
        });
    </script>
@endsection
