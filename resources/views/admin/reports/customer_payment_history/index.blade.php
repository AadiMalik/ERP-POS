...
@section('js')
    @include('admin.partials.datatable', [
        ...
        'route' => 'customer-payment-history/data',
        'buttons' => false,
        'pageLength' => 25,
        'class' => 'customer_payment_history_table',
        'variable' => 'customer_payment_history_table',
        'datefilter' => true,
        'params' =>
            "business_id:$('#business_id').val(),user_id:$('#user_id').val(),payment_method:$('#payment_method').val()",
    ])
    ...
    <script>
        ...
        $('#search_btn').click(function() {
            initDataTablecustomer_payment_history_table();
            refreshTotals();
        });

        function refreshTotals() {
            $.ajax({
                url: url_local + '/admin/reports/customer-payment-history/data',
                type: 'POST',
                data: $.extend({
        ...
        $('#btn_print').click(function() {
            window.open(buildReportUrl('/admin/reports/customer-payment-history/print'), '_blank');
        });
        $('#btn_pdf').click(function() {
            window.open(buildReportUrl('/admin/reports/customer-payment-history/pdf'), '_blank');
        });
        $('#btn_excel').click(function() {
            window.location.href = buildReportUrl('/admin/reports/customer-payment-history/export');
        });
        $('#btn_csv').click(function() {
            window.location.href = buildReportUrl('/admin/reports/customer-payment-history/export-csv');
        });
    </script>
@endsection
