...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">{{ __('reports.department_wise_employee_report') }}</h4>
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex gap-2">
                    @canAccess('reports.department-wise-employee-report.print')
                    <a href="javascript:void(0);" id="btn_print" class="btn btn-outline-secondary">
                        <i class="fa fa-print"></i> {{ __('common.print') }}
                    </a>
                    @endcanAccess
                    @canAccess('reports.department-wise-employee-report.pdf')
                    <a href="javascript:void(0);" id="btn_pdf" class="btn btn-outline-danger">
                        <i class="fa fa-file-pdf"></i> {{ __('common.pdf') }}
                    </a>
                    @endcanAccess
                    @canAccess('reports.department-wise-employee-report.export')
                    <a href="javascript:void(0);" id="btn_excel" class="btn btn-outline-success">
                        <i class="fa fa-file-excel"></i> {{ __('common.excel') }}
                    </a>
                    @endcanAccess
                    @canAccess('reports.department-wise-employee-report.export-csv')
            ...
            <div class="card-body">
                ...
                <div class="table-responsive p-4">
                    <table id="department_wise_employee_report_table" class="table datatables">
                        <thead>
                            <tr>
...
@section('js')
    @include('admin.partials.datatable', [
        ...
        'route' => 'department-wise-employee-report/data',
        'buttons' => false,
        'pageLength' => 50,
        'notordering' => true,
        'class' => 'department_wise_employee_report_table',
        'variable' => 'department_wise_employee_report_table',
    ...
    <script>
        ...
        $('#search_btn').click(function() {
            initDataTabledepartment_wise_employee_report_table();
        });

        $('#btn_print').click(function() {
            window.open(buildReportUrl('/admin/reports/department-wise-employee-report/print'), '_blank');
        });
        $('#btn_pdf').click(function() {
            window.open(buildReportUrl('/admin/reports/department-wise-employee-report/pdf'), '_blank');
        });
        $('#btn_excel').click(function() {
            window.location.href = buildReportUrl('/admin/reports/department-wise-employee-report/export');
        });
        $('#btn_csv').click(function() {
            window.location.href = buildReportUrl('/admin/reports/department-wise-employee-report/export-csv');
        });
    </script>
@endsection
