...
@section('js')
    ...
    <script>
        function currentReportParams() {
            let p = {};
            business_id:$('#business_id').val(),branch_id:$('#branch_id').val(),warehouse_id:$('#warehouse_id').val(),product_id:$('#product_id').val(),product_variation_id:$('#product_variation_id').val(),report_mode:$('#report_mode').val(),batch_no:$('#batch_no').val(),expiry_within_days:$('#expiry_within_days').val(),expired_only:$('#expired_only').val();
