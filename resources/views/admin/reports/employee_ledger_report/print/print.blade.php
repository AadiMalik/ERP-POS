...
@section('title', __('reports.employee_ledger_report'))
...
@section('content')
    @include('admin.partials.print.header', [
        'business' => $business,
        'branch' => null,
        'title' => __('reports.employee_ledger_report'),
        'doc_no' => '',
    ...
    <table class="print-table">
        <thead>
            <tr>
                ...
                <th>{{ __('reports.col_entry_date') }}</th>
        ...
        <tbody>
            @forelse ($rows as $row)
                <tr>
                    ...
                    <td class="text-right">{{ currency($row->balance_after) }}</td>
                </tr>
            @empty
                <tr>
    ...
    <table class="print-totals">
        <tr class="grand-total">
            ...
            <td class="text-right">{{ currency($rows->sum('debit')) }} / {{ currency($rows->sum('credit')) }}</td>
        </tr>
    </table>
