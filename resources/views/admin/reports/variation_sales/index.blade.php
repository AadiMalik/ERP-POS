...
@section('js')
    @include('admin.partials.datatable', [
        ...
        'route' => 'variation-sales/data',
        'buttons' => false,
        'pageLength' => 50,
        'notordering' => true,
        'class' => 'variation_sales_table',
        'variable' => 'variation_sales_table',
        'datefilter' => true,
        'params' => "business_id:$('#business_id').val(),branch_id:$('#branch_id').val(),order_source_id:$('#order_source_id').val(),product_id:$('#product_id').val(),product_variation_id:$('#product_variation_id').val()",
    ])
    ...
    <script>
        ...
        $('#search_btn').click(function() {
            initDataTablevariation_sales_table();
            refreshTotals();
        });

        function refreshTotals() {
            $.ajax({
                url: url_local + '/admin/reports/variation-sales/data',
                type: 'POST',
                data: $.extend({
        ...
        $('#btn_print').click(function() {
            window.open(buildReportUrl('/admin/reports/variation-sales/print'), '_blank');
        });
        $('#btn_pdf').click(function() {
            window.open(buildReportUrl('/admin/reports/variation-sales/pdf'), '_blank');
        });
        $('#btn_excel').click(function() {
            window.location.href = buildReportUrl('/admin/reports/variation-sales/export');
        });
        $('#btn_csv').click(function() {
            window.location.href = buildReportUrl('/admin/reports/variation-sales/export-csv');
        });
    </script>
@endsection
