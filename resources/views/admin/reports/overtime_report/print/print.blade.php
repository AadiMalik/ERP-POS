...
@section('title', __('reports.overtime_report'))
...
@section('content')
    @include('admin.partials.print.header', [
        'business' => $business,
        'branch' => null,
        'title' => __('reports.overtime_report'),
        'doc_no' => '',
    ...
    <table class="print-totals">
        <tr class="grand-total">
            <td>Total OT Hours / Amount</td>
            <td class="text-right">{{ round($rows->sum('ot_hours'), 2) }} / {{ currency($rows->sum('ot_amount')) }}</td>
        </tr>
    </table>
