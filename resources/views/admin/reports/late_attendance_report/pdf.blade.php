...
<body>
    @include('admin.partials.print.pdf_header', [
        'business' => $business,
        'branch' => null,
        'title' => __('reports.late_attendance_report'),
        'doc_no' => '',
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th class="text-right">Late Minutes</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($rows as $row)
            ...
            @endforelse
            <tr>
                <td colspan="5"><strong>Total Late Minutes</strong></td>
                <td class="text-right"><strong>{{ $rows->sum('late_minutes') }}</strong></td>
            </tr>
        </tbody>
    </table>
</body>
