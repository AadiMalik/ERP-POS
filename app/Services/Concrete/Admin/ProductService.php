                ...
                foreach ($variations as $variation) {
                    ...
                    if (!empty($variation['product_variation_id'])) {
                        ...
                        $this->model_product_variation->getModel()::where(
                            ...
                            'is_purchasable' => array_key_exists('is_purchasable', $variation) ? (bool) $variation['is_purchasable'] : true,
                            'is_sellable' => array_key_exists('is_sellable', $variation) ? (bool) $variation['is_sellable'] : true,
                            'is_raw_material' => (bool) ($variation['is_raw_material'] ?? false),
                            'is_manufactured' => (bool) ($variation['is_manufactured'] ?? false),
                            'track_batch' => (bool) ($variation['track_batch'] ?? false),
                            'track_expiry' => (bool) ($variation['track_expiry'] ?? false),
                            'track_serial_number' => (bool) ($variation['track_serial_number'] ?? false),
