...
/**
 * Department-level rollup of EmployeeCostReportService's per-employee cost
 * calculation (total_earnings + advances disbursed) over a date range.
 */
class DepartmentPayrollCostReportService extends BasePayrollFinanceReportService
{
    public function build(array $filters): Collection
    {
        ...
        $employeeQuery = Employee::with('department')->where('is_deleted', 0);
        ...
        return $employees->groupBy(fn ($e) => $e->department_id ?? 'unassigned')
