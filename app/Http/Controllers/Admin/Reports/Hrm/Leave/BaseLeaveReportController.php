...
/**
 * Shared plumbing for every Leave report - identical shape to
 * BaseEmployeeReportController/BaseAttendanceReportController.
 */
abstract class BaseLeaveReportController extends Controller
{
    use ResponseAPI;
