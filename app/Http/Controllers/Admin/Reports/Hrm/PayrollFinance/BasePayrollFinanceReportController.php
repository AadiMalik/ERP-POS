...
/**
 * Shared plumbing for every Payroll & Employee Finance report (salary
 * structure/component, advances, deductions, ledger, and the payroll-run /
 * payslip / cost-analytics reports in Batch 5 & 7) - identical shape to the
 * other domain base controllers. Route module-gate (module:hrm vs
 * module:payroll) is decided per-route in routes/web.php, not by this class.
 */
abstract class BasePayrollFinanceReportController extends Controller
{
    use ResponseAPI;
