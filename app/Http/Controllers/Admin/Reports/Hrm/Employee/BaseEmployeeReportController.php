...
/**
 * Shared plumbing for every Employee & Organization report (permission
 * middleware, DataTables/print/PDF/Excel/CSV flow, audit logging) - mirrors
 * the existing finance report controllers (e.g. ExpenseReportController)
 * method-for-method. Concrete report controllers only supply the report
 * identity (permissionName/reportKey/viewDir/title), their own filter
 * dropdown data in index(), and the Export class to use.
 */
abstract class BaseEmployeeReportController extends Controller
{
    use ResponseAPI;
