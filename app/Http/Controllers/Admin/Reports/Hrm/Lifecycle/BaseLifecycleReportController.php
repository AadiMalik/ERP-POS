...
/**
 * Shared plumbing for every Lifecycle & Asset report - identical shape to
 * the other domain base controllers.
 */
abstract class BaseLifecycleReportController extends Controller
{
    use ResponseAPI;
