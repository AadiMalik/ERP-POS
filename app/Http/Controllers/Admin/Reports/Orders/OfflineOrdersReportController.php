...
use App\Exports\Orders\OfflineOrdersReportExport;
...
use App\Services\Concrete\Admin\Reports\Orders\OfflineOrdersReportService;
use Illuminate\Http\Request;

class OfflineOrdersReportController extends BaseOrderReportController
{
    public function __construct(
        OfflineOrdersReportService $service,
    ...
    {
        return 'reports.offline-orders-report.view';
    }

    protected function reportKey(): string
    {
        return 'offline-orders-report';
    }

    protected function viewDir(): string
    {
        return 'offline_orders_report';
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.reports.offline_orders_report.index', compact('business', 'branches', 'order_sources', 'customers'));
    }

    protected function exportInstance($rows)
    {
        return new OfflineOrdersReportExport($rows);
    }
}
