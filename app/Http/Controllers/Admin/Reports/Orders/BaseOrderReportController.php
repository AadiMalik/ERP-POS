...
/**
 * Shared plumbing for every Orders report (permission middleware,
 * DataTables/print/PDF/Excel/CSV flow, audit logging) - mirrors
 * BaseEmployeeReportController / finance report controllers. Concrete
 * controllers only supply permissionName/reportKey/viewDir, filter dropdown
 * data in index(), and the Export class via exportInstance().
 */
abstract class BaseOrderReportController extends Controller
{
    use ResponseAPI;
