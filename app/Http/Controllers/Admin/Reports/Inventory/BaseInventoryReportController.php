...
/**
 * Shared plumbing for Inventory Reporting System master reports
 * (Stock / Consumption-adjacent / Recipe). Mirrors BaseOrderReportController.
 */
abstract class BaseInventoryReportController extends Controller
{
    use ResponseAPI;
    ...
    public function print(Request $request)
    {
        ...
        return view("admin.reports.inventory.{$this->viewDir()}.print.print", compact('rows', 'request'));
    }
    ...
    public function pdf(Request $request)
    {
        ...
        return Pdf::loadView("admin.reports.inventory.{$this->viewDir()}.pdf", compact('rows', 'request'))
