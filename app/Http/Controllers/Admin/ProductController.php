...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'variations.*.is_purchasable' => 'nullable|boolean',
            'variations.*.is_sellable' => 'nullable|boolean',
            'variations.*.is_raw_material' => 'nullable|boolean',
            'variations.*.is_manufactured' => 'nullable|boolean',
            'variations.*.track_batch' => 'nullable|boolean',
            'variations.*.track_expiry' => 'nullable|boolean',
            'variations.*.track_serial_number' => 'nullable|boolean',
            ...
            'variations.*.prices.*.price' => 'nullable|numeric|min:0',
            'variations.*.prices.*.minimum_selling_price' => 'nullable|numeric|min:0',
