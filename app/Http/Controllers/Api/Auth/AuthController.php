...
class AuthController extends Controller
{
    ...
    public function __construct(OtpService $otp_service, CustomerAccountService $account_service, UserFcmTokenService $fcm_token_service)
    {
    ...
    public function sendOtp(Request $request)
    {
        ...
        try {
            ...
            // New signup for this business - enforce phone uniqueness when provided.
    ...
    {
        $validate = Validator::make($request->all(), [
            'password' => CustomerAccountService::passwordRules(),
        ]);
        if ($validate->fails()) {
            return $this->validationResponse($validate->errors()->first());
        }
