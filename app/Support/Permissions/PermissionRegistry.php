...
class PermissionRegistry
{
    public static function modules(): array
    {
        return [
            ...
            'serial-number' => ['label' => 'Serial Numbers', 'actions' => [
                'view'   => ['name' => 'serial-number.view', 'label' => 'View', 'is_system' => false],
                'create' => ['name' => 'serial-number.create', 'label' => 'Create', 'is_system' => false],
                'edit'   => ['name' => 'serial-number.edit', 'label' => 'Edit', 'is_system' => false],
                'delete' => ['name' => 'serial-number.delete', 'label' => 'Delete', 'is_system' => false],
                'status' => ['name' => 'serial-number.status', 'label' => 'Change Status', 'is_system' => false],
            ]],
            ...
            'loyalty' => ['label' => 'Loyalty Program', 'actions' => [
                'view'    => ['name' => 'loyalty.view', 'label' => 'View', 'is_system' => false],
                'edit'    => ['name' => 'loyalty.edit', 'label' => 'Manage Settings', 'is_system' => false],
                'adjust'  => ['name' => 'loyalty.adjust', 'label' => 'Manual Point Adjustment', 'is_system' => false],
            ...
            'order' => ['label' => 'Orders', 'actions' => [
                ...
                'correct'         => ['name' => 'order.correct', 'label' => 'Correct Same-Day Order', 'is_system' => false],
            ...
            // Orders / POS sales reports (module:pos routes) - separated from the
            // generic 'reports' group so they can be gated independently, the same
            // way 'hrm-reports'/'payroll-reports' already split out of 'reports'.
            'order-reports' => ['label' => 'Order Reports', 'actions' => [
                'order_detail' => ['name' => 'reports.order-detail.view', 'label' => 'Order Detail Report', 'is_system' => false],
                'order_detail_print' => ['name' => 'reports.order-detail.print', 'label' => 'Order Detail Report - Print', 'is_system' => false],
                'order_detail_pdf' => ['name' => 'reports.order-detail.pdf', 'label' => 'Order Detail Report - PDF', 'is_system' => false],
                'order_detail_export' => ['name' => 'reports.order-detail.export', 'label' => 'Order Detail Report - Export (Excel)', 'is_system' => false],
                'order_detail_export_csv' => ['name' => 'reports.order-detail.export-csv', 'label' => 'Order Detail Report - Export (CSV)', 'is_system' => false],
                'product_sales' => ['name' => 'reports.product-sales.view', 'label' => 'Product-wise Sales Report', 'is_system' => false],
                'product_sales_print' => ['name' => 'reports.product-sales.print', 'label' => 'Product-wise Sales Report - Print', 'is_system' => false],
                'product_sales_pdf' => ['name' => 'reports.product-sales.pdf', 'label' => 'Product-wise Sales Report - PDF', 'is_system' => false],
                'product_sales_export' => ['name' => 'reports.product-sales.export', 'label' => 'Product-wise Sales Report - Export (Excel)', 'is_system' => false],
                'product_sales_export_csv' => ['name' => 'reports.product-sales.export-csv', 'label' => 'Product-wise Sales Report - Export (CSV)', 'is_system' => false],
                'variation_sales' => ['name' => 'reports.variation-sales.view', 'label' => 'Variation-wise Sales Report', 'is_system' => false],
                'variation_sales_print' => ['name' => 'reports.variation-sales.print', 'label' => 'Variation-wise Sales Report - Print', 'is_system' => false],
                'variation_sales_pdf' => ['name' => 'reports.variation-sales.pdf', 'label' => 'Variation-wise Sales Report - PDF', 'is_system' => false],
                'variation_sales_export' => ['name' => 'reports.variation-sales.export', 'label' => 'Variation-wise Sales Report - Export (Excel)', 'is_system' => false],
                'variation_sales_export_csv' => ['name' => 'reports.variation-sales.export-csv', 'label' => 'Variation-wise Sales Report - Export (CSV)', 'is_system' => false],
                'customer_sales' => ['name' => 'reports.customer-sales.view', 'label' => 'Customer-wise Sales Report', 'is_system' => false],
                'customer_sales_print' => ['name' => 'reports.customer-sales.print', 'label' => 'Customer-wise Sales Report - Print', 'is_system' => false],
                'customer_sales_pdf' => ['name' => 'reports.customer-sales.pdf', 'label' => 'Customer-wise Sales Report - PDF', 'is_system' => false],
                'customer_sales_export' => ['name' => 'reports.customer-sales.export', 'label' => 'Customer-wise Sales Report - Export (Excel)', 'is_system' => false],
                'customer_sales_export_csv' => ['name' => 'reports.customer-sales.export-csv', 'label' => 'Customer-wise Sales Report - Export (CSV)', 'is_system' => false],
                'branch_sales' => ['name' => 'reports.branch-sales.view', 'label' => 'Branch-wise Sales Report', 'is_system' => false],
                'branch_sales_print' => ['name' => 'reports.branch-sales.print', 'label' => 'Branch-wise Sales Report - Print', 'is_system' => false],
                'branch_sales_pdf' => ['name' => 'reports.branch-sales.pdf', 'label' => 'Branch-wise Sales Report - PDF', 'is_system' => false],
                'branch_sales_export' => ['name' => 'reports.branch-sales.export', 'label' => 'Branch-wise Sales Report - Export (Excel)', 'is_system' => false],
                'branch_sales_export_csv' => ['name' => 'reports.branch-sales.export-csv', 'label' => 'Branch-wise Sales Report - Export (CSV)', 'is_system' => false],
                'order_source_sales' => ['name' => 'reports.order-source-sales.view', 'label' => 'Order Source Sales Report', 'is_system' => false],
                'order_source_sales_print' => ['name' => 'reports.order-source-sales.print', 'label' => 'Order Source Sales Report - Print', 'is_system' => false],
                'order_source_sales_pdf' => ['name' => 'reports.order-source-sales.pdf', 'label' => 'Order Source Sales Report - PDF', 'is_system' => false],
                'order_source_sales_export' => ['name' => 'reports.order-source-sales.export', 'label' => 'Order Source Sales Report - Export (Excel)', 'is_system' => false],
                'order_source_sales_export_csv' => ['name' => 'reports.order-source-sales.export-csv', 'label' => 'Order Source Sales Report - Export (CSV)', 'is_system' => false],
                'payment_method_sales' => ['name' => 'reports.payment-method-sales.view', 'label' => 'Payment Method Sales Report', 'is_system' => false],
                'payment_method_sales_print' => ['name' => 'reports.payment-method-sales.print', 'label' => 'Payment Method Sales Report - Print', 'is_system' => false],
                'payment_method_sales_pdf' => ['name' => 'reports.payment-method-sales.pdf', 'label' => 'Payment Method Sales Report - PDF', 'is_system' => false],
                'payment_method_sales_export' => ['name' => 'reports.payment-method-sales.export', 'label' => 'Payment Method Sales Report - Export (Excel)', 'is_system' => false],
                'payment_method_sales_export_csv' => ['name' => 'reports.payment-method-sales.export-csv', 'label' => 'Payment Method Sales Report - Export (CSV)', 'is_system' => false],
                'order_status_report' => ['name' => 'reports.order-status-report.view', 'label' => 'Order Status Report', 'is_system' => false],
                'order_status_report_print' => ['name' => 'reports.order-status-report.print', 'label' => 'Order Status Report - Print', 'is_system' => false],
                'order_status_report_pdf' => ['name' => 'reports.order-status-report.pdf', 'label' => 'Order Status Report - PDF', 'is_system' => false],
                'order_status_report_export' => ['name' => 'reports.order-status-report.export', 'label' => 'Order Status Report - Export (Excel)', 'is_system' => false],
                'order_status_report_export_csv' => ['name' => 'reports.order-status-report.export-csv', 'label' => 'Order Status Report - Export (CSV)', 'is_system' => false],
                'cancelled_orders' => ['name' => 'reports.cancelled-orders.view', 'label' => 'Cancelled Orders Report', 'is_system' => false],
                'cancelled_orders_print' => ['name' => 'reports.cancelled-orders.print', 'label' => 'Cancelled Orders Report - Print', 'is_system' => false],
                'cancelled_orders_pdf' => ['name' => 'reports.cancelled-orders.pdf', 'label' => 'Cancelled Orders Report - PDF', 'is_system' => false],
                'cancelled_orders_export' => ['name' => 'reports.cancelled-orders.export', 'label' => 'Cancelled Orders Report - Export (Excel)', 'is_system' => false],
                'cancelled_orders_export_csv' => ['name' => 'reports.cancelled-orders.export-csv', 'label' => 'Cancelled Orders Report - Export (CSV)', 'is_system' => false],
                'due_credit_sales' => ['name' => 'reports.due-credit-sales.view', 'label' => 'Due / Credit Sales Report', 'is_system' => false],
                'due_credit_sales_print' => ['name' => 'reports.due-credit-sales.print', 'label' => 'Due / Credit Sales Report - Print', 'is_system' => false],
                'due_credit_sales_pdf' => ['name' => 'reports.due-credit-sales.pdf', 'label' => 'Due / Credit Sales Report - PDF', 'is_system' => false],
                'due_credit_sales_export' => ['name' => 'reports.due-credit-sales.export', 'label' => 'Due / Credit Sales Report - Export (Excel)', 'is_system' => false],
                'due_credit_sales_export_csv' => ['name' => 'reports.due-credit-sales.export-csv', 'label' => 'Due / Credit Sales Report - Export (CSV)', 'is_system' => false],
                'discount_report' => ['name' => 'reports.discount-report.view', 'label' => 'Discount Report', 'is_system' => false],
                'discount_report_print' => ['name' => 'reports.discount-report.print', 'label' => 'Discount Report - Print', 'is_system' => false],
                'discount_report_pdf' => ['name' => 'reports.discount-report.pdf', 'label' => 'Discount Report - PDF', 'is_system' => false],
                'discount_report_export' => ['name' => 'reports.discount-report.export', 'label' => 'Discount Report - Export (Excel)', 'is_system' => false],
                'discount_report_export_csv' => ['name' => 'reports.discount-report.export-csv', 'label' => 'Discount Report - Export (CSV)', 'is_system' => false],
                'loyalty_report' => ['name' => 'reports.loyalty-report.view', 'label' => 'Loyalty Report', 'is_system' => false],
                'loyalty_report_print' => ['name' => 'reports.loyalty-report.print', 'label' => 'Loyalty Report - Print', 'is_system' => false],
                'loyalty_report_pdf' => ['name' => 'reports.loyalty-report.pdf', 'label' => 'Loyalty Report - PDF', 'is_system' => false],
                'loyalty_report_export' => ['name' => 'reports.loyalty-report.export', 'label' => 'Loyalty Report - Export (Excel)', 'is_system' => false],
                'loyalty_report_export_csv' => ['name' => 'reports.loyalty-report.export-csv', 'label' => 'Loyalty Report - Export (CSV)', 'is_system' => false],
                'customer_loyalty_report' => ['name' => 'reports.customer-loyalty-report.view', 'label' => 'Customer Loyalty History Report', 'is_system' => false],
                'customer_loyalty_report_print' => ['name' => 'reports.customer-loyalty-report.print', 'label' => 'Customer Loyalty History Report - Print', 'is_system' => false],
                'customer_loyalty_report_pdf' => ['name' => 'reports.customer-loyalty-report.pdf', 'label' => 'Customer Loyalty History Report - PDF', 'is_system' => false],
                'customer_loyalty_report_export' => ['name' => 'reports.customer-loyalty-report.export', 'label' => 'Customer Loyalty History Report - Export (Excel)', 'is_system' => false],
                'customer_loyalty_report_export_csv' => ['name' => 'reports.customer-loyalty-report.export-csv', 'label' => 'Customer Loyalty History Report - Export (CSV)', 'is_system' => false],
                'order_tax_report' => ['name' => 'reports.order-tax-report.view', 'label' => 'Order Tax Report', 'is_system' => false],
                'order_tax_report_print' => ['name' => 'reports.order-tax-report.print', 'label' => 'Order Tax Report - Print', 'is_system' => false],
                'order_tax_report_pdf' => ['name' => 'reports.order-tax-report.pdf', 'label' => 'Order Tax Report - PDF', 'is_system' => false],
                'order_tax_report_export' => ['name' => 'reports.order-tax-report.export', 'label' => 'Order Tax Report - Export (Excel)', 'is_system' => false],
                'order_tax_report_export_csv' => ['name' => 'reports.order-tax-report.export-csv', 'label' => 'Order Tax Report - Export (CSV)', 'is_system' => false],
                'top_selling' => ['name' => 'reports.top-selling.view', 'label' => 'Top Selling Report', 'is_system' => false],
                'top_selling_print' => ['name' => 'reports.top-selling.print', 'label' => 'Top Selling Report - Print', 'is_system' => false],
                'top_selling_pdf' => ['name' => 'reports.top-selling.pdf', 'label' => 'Top Selling Report - PDF', 'is_system' => false],
                'top_selling_export' => ['name' => 'reports.top-selling.export', 'label' => 'Top Selling Report - Export (Excel)', 'is_system' => false],
                'top_selling_export_csv' => ['name' => 'reports.top-selling.export-csv', 'label' => 'Top Selling Report - Export (CSV)', 'is_system' => false],
                'offline_orders_report' => ['name' => 'reports.offline-orders-report.view', 'label' => 'Offline Orders Report', 'is_system' => false],
                'offline_orders_report_print' => ['name' => 'reports.offline-orders-report.print', 'label' => 'Offline Orders Report - Print', 'is_system' => false],
                'offline_orders_report_pdf' => ['name' => 'reports.offline-orders-report.pdf', 'label' => 'Offline Orders Report - PDF', 'is_system' => false],
                'offline_orders_report_export' => ['name' => 'reports.offline-orders-report.export', 'label' => 'Offline Orders Report - Export (Excel)', 'is_system' => false],
                'offline_orders_report_export_csv' => ['name' => 'reports.offline-orders-report.export-csv', 'label' => 'Offline Orders Report - Export (CSV)', 'is_system' => false],
                'order_correction_report' => ['name' => 'reports.order-correction-report.view', 'label' => 'Order Correction Report', 'is_system' => false],
                'order_correction_report_print' => ['name' => 'reports.order-correction-report.print', 'label' => 'Order Correction Report - Print', 'is_system' => false],
            ...
            'reports' => ['label' => 'Reports', 'actions' => [
                ...
                'stock_summary' => ['name' => 'reports.stock-summary.view', 'label' => 'Stock Summary', 'is_system' => false],
                'stock_summary_print' => ['name' => 'reports.stock-summary.print', 'label' => 'Stock Summary - Print', 'is_system' => false],
                'stock_summary_pdf' => ['name' => 'reports.stock-summary.pdf', 'label' => 'Stock Summary - PDF', 'is_system' => false],
                'stock_summary_export' => ['name' => 'reports.stock-summary.export', 'label' => 'Stock Summary - Export (Excel)', 'is_system' => false],
                'stock_summary_export_csv' => ['name' => 'reports.stock-summary.export-csv', 'label' => 'Stock Summary - Export (CSV)', 'is_system' => false],
                'stock_valuation' => ['name' => 'reports.stock-valuation.view', 'label' => 'Stock Valuation', 'is_system' => false],
                'stock_valuation_print' => ['name' => 'reports.stock-valuation.print', 'label' => 'Stock Valuation - Print', 'is_system' => false],
                ...
                'product_shares_export' => ['name' => 'reports.product-shares.export', 'label' => 'Product Shares - Export (Excel)', 'is_system' => false],
                'product_shares_export_csv' => ['name' => 'reports.product-shares.export-csv', 'label' => 'Product Shares - Export (CSV)', 'is_system' => false],
                'stock_aging' => ['name' => 'reports.stock-aging.view', 'label' => 'Stock Aging & Movement', 'is_system' => false],
                'stock_aging_print' => ['name' => 'reports.stock-aging.print', 'label' => 'Stock Aging & Movement - Print', 'is_system' => false],
                'stock_aging_pdf' => ['name' => 'reports.stock-aging.pdf', 'label' => 'Stock Aging & Movement - PDF', 'is_system' => false],
                'stock_aging_export' => ['name' => 'reports.stock-aging.export', 'label' => 'Stock Aging & Movement - Export (Excel)', 'is_system' => false],
                'stock_aging_export_csv' => ['name' => 'reports.stock-aging.export-csv', 'label' => 'Stock Aging & Movement - Export (CSV)', 'is_system' => false],
                'stock_transfer_report' => ['name' => 'reports.stock-transfer-report.view', 'label' => 'Stock Transfer Report', 'is_system' => false],
                'stock_transfer_report_print' => ['name' => 'reports.stock-transfer-report.print', 'label' => 'Stock Transfer Report - Print', 'is_system' => false],
                'stock_transfer_report_pdf' => ['name' => 'reports.stock-transfer-report.pdf', 'label' => 'Stock Transfer Report - PDF', 'is_system' => false],
                'stock_transfer_report_export' => ['name' => 'reports.stock-transfer-report.export', 'label' => 'Stock Transfer Report - Export (Excel)', 'is_system' => false],
                'stock_transfer_report_export_csv' => ['name' => 'reports.stock-transfer-report.export-csv', 'label' => 'Stock Transfer Report - Export (CSV)', 'is_system' => false],
                'stock_reconciliation' => ['name' => 'reports.stock-reconciliation.view', 'label' => 'Stock Reconciliation & Adjustment', 'is_system' => false],
                'stock_reconciliation_print' => ['name' => 'reports.stock-reconciliation.print', 'label' => 'Stock Reconciliation & Adjustment - Print', 'is_system' => false],
                'stock_reconciliation_pdf' => ['name' => 'reports.stock-reconciliation.pdf', 'label' => 'Stock Reconciliation & Adjustment - PDF', 'is_system' => false],
                'stock_reconciliation_export' => ['name' => 'reports.stock-reconciliation.export', 'label' => 'Stock Reconciliation & Adjustment - Export (Excel)', 'is_system' => false],
                'stock_reconciliation_export_csv' => ['name' => 'reports.stock-reconciliation.export-csv', 'label' => 'Stock Reconciliation & Adjustment - Export (CSV)', 'is_system' => false],
                'batch_expiry' => ['name' => 'reports.batch-expiry.view', 'label' => 'Batch/Lot & Expiry', 'is_system' => false],
                'batch_expiry_print' => ['name' => 'reports.batch-expiry.print', 'label' => 'Batch/Lot & Expiry - Print', 'is_system' => false],
                'batch_expiry_pdf' => ['name' => 'reports.batch-expiry.pdf', 'label' => 'Batch/Lot & Expiry - PDF', 'is_system' => false],
                'batch_expiry_export' => ['name' => 'reports.batch-expiry.export', 'label' => 'Batch/Lot & Expiry - Export (Excel)', 'is_system' => false],
                'batch_expiry_export_csv' => ['name' => 'reports.batch-expiry.export-csv', 'label' => 'Batch/Lot & Expiry - Export (CSV)', 'is_system' => false],
                'stock_loss' => ['name' => 'reports.stock-loss.view', 'label' => 'Stock Loss/Wastage/Damage', 'is_system' => false],
                'stock_loss_print' => ['name' => 'reports.stock-loss.print', 'label' => 'Stock Loss/Wastage/Damage - Print', 'is_system' => false],
                ...
                'serial_number_register' => ['name' => 'reports.serial-number-register.view', 'label' => 'Serial Number Register', 'is_system' => false],
                'serial_number_register_print' => ['name' => 'reports.serial-number-register.print', 'label' => 'Serial Number Register - Print', 'is_system' => false],
                'serial_number_register_pdf' => ['name' => 'reports.serial-number-register.pdf', 'label' => 'Serial Number Register - PDF', 'is_system' => false],
                'serial_number_register_export' => ['name' => 'reports.serial-number-register.export', 'label' => 'Serial Number Register - Export (Excel)', 'is_system' => false],
                'serial_number_register_export_csv' => ['name' => 'reports.serial-number-register.export-csv', 'label' => 'Serial Number Register - Export (CSV)', 'is_system' => false],
                'serial_number_available' => ['name' => 'reports.serial-number-available.view', 'label' => 'Available Serial Numbers', 'is_system' => false],
                'serial_number_available_print' => ['name' => 'reports.serial-number-available.print', 'label' => 'Available Serial Numbers - Print', 'is_system' => false],
                'serial_number_available_pdf' => ['name' => 'reports.serial-number-available.pdf', 'label' => 'Available Serial Numbers - PDF', 'is_system' => false],
                'serial_number_available_export' => ['name' => 'reports.serial-number-available.export', 'label' => 'Available Serial Numbers - Export (Excel)', 'is_system' => false],
                'serial_number_available_export_csv' => ['name' => 'reports.serial-number-available.export-csv', 'label' => 'Available Serial Numbers - Export (CSV)', 'is_system' => false],
                'serial_number_sold' => ['name' => 'reports.serial-number-sold.view', 'label' => 'Sold Serial Numbers', 'is_system' => false],
                'serial_number_sold_print' => ['name' => 'reports.serial-number-sold.print', 'label' => 'Sold Serial Numbers - Print', 'is_system' => false],
                'serial_number_sold_pdf' => ['name' => 'reports.serial-number-sold.pdf', 'label' => 'Sold Serial Numbers - PDF', 'is_system' => false],
                'serial_number_sold_export' => ['name' => 'reports.serial-number-sold.export', 'label' => 'Sold Serial Numbers - Export (Excel)', 'is_system' => false],
                'serial_number_sold_export_csv' => ['name' => 'reports.serial-number-sold.export-csv', 'label' => 'Sold Serial Numbers - Export (CSV)', 'is_system' => false],
                'serial_number_movement' => ['name' => 'reports.serial-number-movement.view', 'label' => 'Serial Number Movement History', 'is_system' => false],
                'serial_number_movement_print' => ['name' => 'reports.serial-number-movement.print', 'label' => 'Serial Number Movement History - Print', 'is_system' => false],
                'serial_number_movement_pdf' => ['name' => 'reports.serial-number-movement.pdf', 'label' => 'Serial Number Movement History - PDF', 'is_system' => false],
                'serial_number_movement_export' => ['name' => 'reports.serial-number-movement.export', 'label' => 'Serial Number Movement History - Export (Excel)', 'is_system' => false],
                'serial_number_movement_export_csv' => ['name' => 'reports.serial-number-movement.export-csv', 'label' => 'Serial Number Movement History - Export (CSV)', 'is_system' => false],
                'serial_number_customer' => ['name' => 'reports.serial-number-customer.view', 'label' => 'Customer-wise Serial Numbers', 'is_system' => false],
                'serial_number_customer_print' => ['name' => 'reports.serial-number-customer.print', 'label' => 'Customer-wise Serial Numbers - Print', 'is_system' => false],
                'serial_number_customer_pdf' => ['name' => 'reports.serial-number-customer.pdf', 'label' => 'Customer-wise Serial Numbers - PDF', 'is_system' => false],
                'serial_number_customer_export' => ['name' => 'reports.serial-number-customer.export', 'label' => 'Customer-wise Serial Numbers - Export (Excel)', 'is_system' => false],
                'serial_number_customer_export_csv' => ['name' => 'reports.serial-number-customer.export-csv', 'label' => 'Customer-wise Serial Numbers - Export (CSV)', 'is_system' => false],
                ...
                'business_summary' => ['name' => 'reports.business-summary.view', 'label' => 'Business Summary', 'is_system' => false],
                'business_summary_print' => ['name' => 'reports.business-summary.print', 'label' => 'Business Summary - Print', 'is_system' => false],
                'business_summary_pdf' => ['name' => 'reports.business-summary.pdf', 'label' => 'Business Summary - PDF', 'is_system' => false],
                'business_summary_export' => ['name' => 'reports.business-summary.export', 'label' => 'Business Summary - Export (Excel)', 'is_system' => false],
                'business_summary_export_csv' => ['name' => 'reports.business-summary.export-csv', 'label' => 'Business Summary - Export (CSV)', 'is_system' => false],
                ...
                'service_sale_report_export' => ['name' => 'reports.service-sale-report.export', 'label' => 'Sale Service Report - Export (Excel)', 'is_system' => false],
                'service_sale_report_export_csv' => ['name' => 'reports.service-sale-report.export-csv', 'label' => 'Sale Service Report - Export (CSV)', 'is_system' => false],
                'service_purchase_report'  => ['name' => 'reports.service-purchase-report.view', 'label' => 'Purchase Service Report', 'is_system' => false],
                'service_purchase_report_print' => ['name' => 'reports.service-purchase-report.print', 'label' => 'Purchase Service Report - Print', 'is_system' => false],
                'service_purchase_report_pdf' => ['name' => 'reports.service-purchase-report.pdf', 'label' => 'Purchase Service Report - PDF', 'is_system' => false],
                'service_purchase_report_export' => ['name' => 'reports.service-purchase-report.export', 'label' => 'Purchase Service Report - Export (Excel)', 'is_system' => false],
                'service_purchase_report_export_csv' => ['name' => 'reports.service-purchase-report.export-csv', 'label' => 'Purchase Service Report - Export (CSV)', 'is_system' => false],
                'service_transaction_summary' => ['name' => 'reports.service-transaction-summary.view', 'label' => 'Service Transaction Summary', 'is_system' => false],
                'service_transaction_summary_print' => ['name' => 'reports.service-transaction-summary.print', 'label' => 'Service Transaction Summary - Print', 'is_system' => false],
                'service_transaction_summary_pdf' => ['name' => 'reports.service-transaction-summary.pdf', 'label' => 'Service Transaction Summary - PDF', 'is_system' => false],
                'service_transaction_summary_export' => ['name' => 'reports.service-transaction-summary.export', 'label' => 'Service Transaction Summary - Export (Excel)', 'is_system' => false],
                'service_transaction_summary_export_csv' => ['name' => 'reports.service-transaction-summary.export-csv', 'label' => 'Service Transaction Summary - Export (CSV)', 'is_system' => false],
                'service_payment_report'   => ['name' => 'reports.service-payment-report.view', 'label' => 'Service Payment Report', 'is_system' => false],
                'service_payment_report_print' => ['name' => 'reports.service-payment-report.print', 'label' => 'Service Payment Report - Print', 'is_system' => false],
                'service_payment_report_pdf' => ['name' => 'reports.service-payment-report.pdf', 'label' => 'Service Payment Report - PDF', 'is_system' => false],
                'service_payment_report_export' => ['name' => 'reports.service-payment-report.export', 'label' => 'Service Payment Report - Export (Excel)', 'is_system' => false],
                'service_payment_report_export_csv' => ['name' => 'reports.service-payment-report.export-csv', 'label' => 'Service Payment Report - Export (CSV)', 'is_system' => false],
                ...
                'cash_flow'              => ['name' => 'reports.cash-flow.view', 'label' => 'Cash Flow Statement', 'is_system' => false],
                'cash_flow_print' => ['name' => 'reports.cash-flow.print', 'label' => 'Cash Flow Statement - Print', 'is_system' => false],
                'cash_flow_pdf' => ['name' => 'reports.cash-flow.pdf', 'label' => 'Cash Flow Statement - PDF', 'is_system' => false],
                'cash_flow_export' => ['name' => 'reports.cash-flow.export', 'label' => 'Cash Flow Statement - Export (Excel)', 'is_system' => false],
                'cash_flow_export_csv' => ['name' => 'reports.cash-flow.export-csv', 'label' => 'Cash Flow Statement - Export (CSV)', 'is_system' => false],
            ...
            'manufacturing-reports' => ['label' => 'Manufacturing Reports', 'actions' => [
                ...
                'recipe_bom_report' => ['name' => 'reports.recipe-bom-report.view', 'label' => 'Recipe/BOM Report', 'is_system' => false],
                'recipe_bom_report_print' => ['name' => 'reports.recipe-bom-report.print', 'label' => 'Recipe/BOM Report - Print', 'is_system' => false],
                'recipe_bom_report_pdf' => ['name' => 'reports.recipe-bom-report.pdf', 'label' => 'Recipe/BOM Report - PDF', 'is_system' => false],
