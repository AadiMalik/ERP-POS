...
return [
    ...
    'free_delivery_min_order_amount' => 'ایں مقدار ءَ پہ مفت ڈیلیوری',
    'free_delivery_hint' => 'ایسے آرڈر جو ایں مقدار ءَ برابر یا زیاتر بیت اے شاخ ءَ مفت ڈیلیوری گیرنت۔ خالی بیلگ ءَ بند کنگ۔',
