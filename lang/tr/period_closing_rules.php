...
return [
    'title' => 'Dönem Kapanış Kuralları',
    'intro' => 'Choose which checks must pass before a period (automatic or manual) is allowed to close. If any enabled check finds pending items, the period is left open and the specific items are shown on the Muhasebe Dönems screen.',
    'check_unposted_journals' => 'Block closing if there are unposted (pending) journal entries in the period',
    'check_purchase_returns' => 'Block closing if there are Alım İades pending approval',
